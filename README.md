...
> [`spotipy-dev/spotipy`](https://github.com/spotipy-dev/spotipy) at commit
> `4f5759dbfb4506c7b6280572a4db1aabc1ac778d` (2025-04-21), redistributed under that
...
> to on 2025-04-21; see `pinning.md` in the harness output for
